...
const converted_source_image_files_path = path.join(tempDir, ".converted_source_image_files");
const converted_target_image_files_path = path.join(tempDir, ".converted_target_image_files");
